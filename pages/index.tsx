      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center py-24">
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-xl p-6 max-w-sm mx-auto mb-8">
            <h3 className="text-2xl font-bold mb-2">Premium Green</h3>
            <p className="text-4xl font-bold text-blue-600 mb-2">$20<span className="text-lg text-gray-600">/month</span></p>
